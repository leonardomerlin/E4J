...
//
//    /**
//     * Create the actor link model depending upon its type and value and add it
//     * to the dictionary with link ID as key.
//     *
//     * @param link ERlement link tag.
//     */
...
//
//    /**
//     * Create the intention link model depending upon its type and value and add
//     * it to the dictionary with link ID as key.
//     *
//     * @param link ERlement link tag.
//     */
...
//     *
//     * @param isin ERelement tag that contains parent and child id as its
//     * attribute i.e {parent=ID, child=ID}
//     */
...
//     *
//     * @param actor ERelement type which contains all the required information
...
//     * that
//     *
//     * @param intention ERelement type which contains all the required
//     * information about the Intention intention.
//     */
...
//     *
//     * @param file Target file IFile f.
//     */
...
//
//    /**
//     * Prompts the user to either continue with the conversion process or to
//     * stop it.
//     *
