...
% \newcommand{\titulo}{Desenvolvendo e Ingratando um Editor \emph{i}* para JGOOSE}
\newcommand{\titulo}{E4J: Editor \emph{i}* para JGOOSE}
% Datas
\newcommand{\ano}{2013}
...
\include{iniciais/aprovacao}

\oneandhalfspacing

%Itens opcionais
\include{iniciais/dedicatoria}
\include{iniciais/epigrafe}
\include{iniciais/agradecimento}

% Volta a numeração arábica
\pagestyle{plain}
\include{iniciais/sumario} % Listas(Figuras,Tabelas,Smbols) e Sumrio
